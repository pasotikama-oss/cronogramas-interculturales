              ...
              <div className="space-y-2">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-xs font-bold text-slate-900">Descargar en Excel (CSV estructurado)</div>
                      <div className="text-[11px] text-slate-500">Formato compatible con Microsoft Excel y hojas de cálculo</div>
                    </div>
                  </div>
